...
def client(self):
        ...
        self.delete_client.clicked.connect(lambda: delete(self,'cliente', self.table_clients))
        self.edit_client.clicked.connect(lambda: update(self,'cliente', self.table_clients))
