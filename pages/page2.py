...
def provider(self):
    ...
    self.edit_provider.clicked.connect(lambda: update('fornecedor', self.table_provider))
    ...
    self.search_provider.textChanged.connect(lambda: search('fornecedor', self.search_provider, self.table_provider))
